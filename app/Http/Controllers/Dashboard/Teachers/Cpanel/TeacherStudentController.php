...
namespace App\Http\Controllers\Dashboard\Teachers\Cpanel;
...
class TeacherStudentController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.teachers.cpanel.students.index', compact('students'));
    }
    ...
    public function sections()
    {
        ...
        return view('dashboard.teachers.cpanel.sections.index', compact('sections'));
    }
