                        ...
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic17.jpg')}}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic18.jpg')}}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic19.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="column mcb-column one column_column">
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic20.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="column mcb-column one column_column">
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic21.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="column mcb-column one column_column">
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic22.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="column mcb-column one column_column">
                        <div class="column_attr clearfix" style=" padding:0 10% 0 0;">
                            ...
                            <h5>Ut ultricies imperdiet sodales. Aliquam fringilla aliquam.</h5>
                            <p>
                                Proin bibendum sollicitudin feugiat. Curabitur ut egestas
                                justo, vitae molestie ante.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic23.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="column mcb-column one column_column">
                ...
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column one column_image">
                        <div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
                            <div class="image_wrapper">
                                <img class="scale-with-grid"
                                     src="{{asset('ashry/front/content/school2/images/home_school2_pic24.jpg')}}">
                            </div>
                        </div>
                    </div>
                    <div class="column mcb-column one column_column">
                    ...
                    <div class="column mcb-column one-second column_column">
                        <div class="column_attr clearfix align_center">
                            ...
                            <p style="color:#fff">
                                ...
                                Nunc id tellus finibus, eleifend mi vel. Maximus justo. Maecenas mi tortor, pellentesque a aliquam ut.
                            </p>
